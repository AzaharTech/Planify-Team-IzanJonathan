package main.java.com.azahartech.eventdev.util;
...
class UtilidadValidacionTest {
        ...
        void esEmailValido_DebeDevolverTrue_ParaUnEmailCorrecto() {
            ...
            // Verificamos que, para esta entrada, el resultado es el que esperamos (true).
                    Assertions.assertTrue(resultado, "El email válido fue incorrectamente marcado como inválido");
        ...
        void esEmailValido_DebeDevolverFalse_ParaUnEmailSinArroba() {
            ...
            // 3. Assert
            Assertions.assertFalse(resultado, "El email sin arroba fue incorrectamente marcado como válido");
        }
        ...
        Assertions.assertFalse(UtilidadValidacion.esEmailValido(null), "El valor null  debería ser inválido");
                Assertions.assertFalse(UtilidadValidacion.esEmailValido(""), "Un string vacío  debería ser inválido");
        }
}
